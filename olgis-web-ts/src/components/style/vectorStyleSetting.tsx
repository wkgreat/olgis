        ...
        if(!layer) {
            ...
            return (
                <div style={{maxWidth: 680, margin: 10}}>
                    ...
                    <div><Typography variant="h6" color="secondary">点属性</Typography></div>
                    ...
                    <div><Typography variant="h6" color="secondary">线属性</Typography></div>
                    <StrokeSetting style={options.stroke} open={true} paperProps={{elevation:2}}
                                   onChange={(opt)=>setOp({stroke: new Stroke(opt)})}/>
                    <div><Typography variant="h6" color="secondary">面属性</Typography></div>
